<?php
   require("../connection/connection.php");// Adjust path if necessary, if this seeder is in cinema-server/
    // If your seeder is in cinema-server/seeders, and connection.php is in cinema-server/, use:
    ...
    $movies = [
        [
            ...
            'poster_url' => '../assets/dne2.jpg', // Path relative to http://localhost/
        ...
        [
            ...
            'rating' => 8.6,
            // --- CRITICAL CHANGE HERE ---
            'poster_url' => '/cinema-server/posters/oppenheimer.jpg', // Path relative to http://localhost/
        ...
        [
            ...
            'rating' => 8.4,
            // --- CRITICAL CHANGE HERE ---
            'poster_url' => '/cinema-server/posters/interstellar.jpg', // Path relative to http://localhost/
        ...
        [
            ...
            'rating' => 8.8,
            // --- CRITICAL CHANGE HERE ---
            'poster_url' => '/cinema-server/posters/inception.jpg', // Path relative to http://localhost/
    ...
    foreach ($movies as $movieData) {
        // Check if movie already exists to prevent duplicate entries on re-run
        ...
        if ($result->num_rows == 0) {
            // Movie does not exist, insert it
